class CountyDemographics:
    ...
    def __eq__(self, other):
        return (self is other) or (type(self) == type(other) and (
                    self.age == other.age and self.county == other.county and
                    self.education == other.education) and self.ethnicities == other.ethnicities and
                                   self.income == other.income and self.population == other.population and
