...
class TestCases(unittest.TestCase):
    ...
    def test_population_total2(self):
        input = build_data.get_data()
        expected = 318857056
        result = hw3.population_total(input)
        self.assertEqual(expected,result)

    # Part 2
    def test_state_filter1(self):
        input = 'CA'
        input2 = build_data.get_data()
        expected = 58
        result = hw3.filter_by_state(input2,input)
        self.assertEqual(expected,len(result))

    def test_state_filter2(self):
        input1 = reduced_data
        input2 = 'MO'
    ...
    # Part 3
    def test_pop_by_ed1(self):
        input = reduced_data
        expected = 195114.091
        result = hw3.population_by_education(input,"Bachelor's Degree or Higher")
        self.assertAlmostEqual(expected,result,2)

    def test_pop_by_ed2(self):
        input = [reduced_data[0], reduced_data[1], reduced_data[2]]
        expected = 348191.42
        result = hw3.population_by_education(input, "High School or Higher")
        self.assertAlmostEqual(expected, result, 2)

    # test population_by_ethnicity
    def test_pop_by_eth1(self):
        input = reduced_data
        expected = 41181.32
        result = hw3.population_by_ethnicity(input,"Asian Alone")
        self.assertAlmostEqual(expected,result,2)

    def test_pop_by_eth2(self):
        input = [reduced_data[0], reduced_data[1], reduced_data[2]]
        expected = 12213.45
    ...
    def test_pop_below1(self):
        input = reduced_data
        expected = 107711.71
        result = hw3.population_below_poverty_level(input)
        self.assertAlmostEqual(expected, result, 2)

    def test_pop_below2(self):
        input = [reduced_data[0], reduced_data[1], reduced_data[2]]
        expected = 59074.46
        result = hw3.population_below_poverty_level(input)
        self.assertAlmostEqual(expected, result, 2)
    ...
    def test_perc_by_eth1(self):
        input = reduced_data
        expected = 6.28
        result = hw3.percent_by_ethnicity(input,"Asian Alone")
        self.assertAlmostEqual(expected,result,2)

    def test_perc_by_eth2(self):
        input = [reduced_data[0], reduced_data[1], reduced_data[2]]
        expected = 3.08
    ...
    def test_perc_below1(self):
        input = reduced_data
        expected = 16.42
        result = hw3.percent_below_poverty_line(input)
        self.assertAlmostEqual(expected, result, 2)

    def test_perc_below2(self):
        input = [reduced_data[0], reduced_data[1], reduced_data[2]]
        expected = 14.91
        result = hw3.percent_below_poverty_line(input)
        self.assertAlmostEqual(expected, result, 2)
    ...
    def test_ed_greater1(self):
        ...
        {'2010 Population': 200849,
         ...
         'Population per Square Mile': 197.9},
        'CA')]
        result = hw3.education_greater_than(input,"Bachelor's Degree or Higher", 25)
        self.assertEqual(expected,result)

    def test_ed_greater2(self):
        input = reduced_data
        expected = [
    data.CountyDemographics(
        {'Percent 65 and Older': 13.8,
    ...
    data.CountyDemographics(
        ...
        result = hw3.education_greater_than(input,"Bachelor's Degree or Higher",15)
        self.assertEqual(expected,result)

    # test education_less_than
    def test_edu_less_than1(self):
        input = reduced_data
        expected = []
        result = hw3.education_less_than(input,"High School or Higher",30)
        self.assertEqual(expected,result)

    # test ethnicity_greater_than
    def test_eth_greater_that1(self):
        input = reduced_data
        expected = [data.CountyDemographics(
        {'Percent 65 and Older': 11.5,
         'Percent Under 18 Years': 21.7,
        ...
        {'2010 Population': 200849,
         ...
         'Population per Square Mile': 197.9},
        'CA')]
        result = hw3.ethinicity_greater_than(reduced_data,"Asian Alone",10)
        self.assertEqual(expected,result)

    def test_eth_greater_than2(self):
        input = reduced_data
        expected = [data.CountyDemographics(
        {'Percent 65 and Older': 13.8,
         'Percent Under 18 Years': 25.2,
        ...
        {'2010 Population': 54571,
         ...
         'Population per Square Mile': 91.8},
        'AL')]
        result = hw3.ethinicity_greater_than(input,"Black Alone",10)
        self.assertEqual(expected,result)

    # test ethnicity_less_than
    def test_eth_less1(self):
        input = reduced_data
        expected = [data.CountyDemographics(
        {'Percent 65 and Older': 13.8,
         'Percent Under 18 Years': 25.2,
        ...
        {'2010 Population': 42201,
         ...
         'Population per Square Mile': 61.9},
        'MO')]
        result = hw3.ethnicity_less_than(input,"American Indian and Alaska Native Alone",1)
        self.assertEqual(expected,result)
    ...
    def test_eth_less2(self):
        ...
        {'2010 Population': 42201,
         ...
         'Population per Square Mile': 61.9},
        'MO')]
        result = hw3.ethnicity_less_than(input,'Two or More Races',2)
        self.assertEqual(expected,result)

    # test below_poverty_level_greater_than
    def test_below_pov_greater1(self):
        input = reduced_data
        expected = [data.CountyDemographics(
        {'Percent 65 and Older': 15.3,
         'Percent Under 18 Years': 25.1,
        ...
        {'2010 Population': 61948,
         ...
         'Population per Square Mile': 104.4},
        'AR'),]
        result = hw3.pov_greater_than(input,20)
        self.assertEqual(expected,result)

    def test_below_pov_greater2(self):
        input = reduced_data
        expected = []
        result = hw3.pov_greater_than(input,25)
        self.assertEqual(expected,result)

    # test below_poverty_level_less_than
    def test_below_pov_less1(self):
        input = reduced_data
        expected = []
        result = hw3.pov_less_than(input,10)
        self.assertEqual(expected,result)

    def test_below_pov_less2(self):
        input = reduced_data
        expected = [data.CountyDemographics(
        {'Percent 65 and Older': 13.8,
         'Percent Under 18 Years': 25.2,
        ...
        {'2010 Population': 7208,
         ...
         'Population per Square Mile': 3.0},
        'WY')]
        result = hw3.pov_less_than(input,15)
        self.assertEqual(expected,result)
